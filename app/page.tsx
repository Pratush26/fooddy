...
export default function Home() {
  return (
    <main>
      <section className="bg-linear-to-r from-secondary to-background h-[90vh]">
      <div className="w-11/12 h-full mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center-safe justify-items-center-safe">
        {/* Left Content */}
